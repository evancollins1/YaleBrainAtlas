...
# Input 1: dataframe = dataframe name with 690 rows corresponding to 696 parcels (first 345 should be left parcels; last 345 should be right parcels)
...
# Input 1: R_values = 690-length vector of R color values for 696 parcels (on RGB scale)
# Input 2: G_values = 690-length vector of G color values for 696 parcels (on RGB scale)
# Input 3: B_values = 690-length vector of B color values for 696 parcels (on RGB scale)
