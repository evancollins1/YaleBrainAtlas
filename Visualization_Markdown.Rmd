...
# Input 9: extra_text_values = 696-length vector of any additional information to be displayed in hovertext for 696 parcels 
  ...
  plotly_atlas_whole_RH_LH_list[[1]] <- plot_ly(type = "mesh3d",
    ...
    plotly_atlas_whole_RH_LH_list[[2]] <- plot_ly(type = "mesh3d", 
                                                  ...
                                                  hovertext = paste0("Parcel: ", rep(parcel_names, vertex_number_by_parcel)[1:31868],
                                                                    "<br>", rep(extra_text_values, vertex_number_by_parcel)[1:31868])) %>%
      layout(hoverlabel = list(bgcolor = "white", bordercolor = "darkblue", font = list(size = 15, family = "Verdana"))) %>%
      config(displaylogo = F, displayModeBar = F) %>%
      layout(scene = list(camera = list(eye = list(x = 1, y = 1, z = 0)))) #%>%
      #layout(paper_bgcolor = "rgb(68, 68, 68)", plot_bgcolor = "rgb(68, 68, 68)")
    ...
    plotly_atlas_whole_RH_LH_list[[3]] <- plot_ly(type = "mesh3d", 
                                                  ...
                                                  hovertext = paste0("Parcel: ", rep(parcel_names, vertex_number_by_parcel)[31869:length(rep(parcel_names, vertex_number_by_parcel))],
                                                                    "<br>", rep(extra_text_values, vertex_number_by_parcel)[31869:length(rep(parcel_names, vertex_number_by_parcel))])) %>%
      layout(hoverlabel = list(bgcolor = "white", bordercolor = "darkblue", font = list(size = 15, family = "Verdana"))) %>%
      config(displaylogo = F, displayModeBar = F) %>%
      layout(scene = list(camera = list(eye = list(x = 1, y = 1, z = 0)))) #%>%
      #layout(paper_bgcolor = "rgb(68, 68, 68)", plot_bgcolor = "rgb(68, 68, 68)")
...
img1 <- plot_plotly_atlas_whole_RH_LH(atlas, atlas_LH, atlas_RH, atlas_deep_LH, atlas_deep_RH, freq_colors[[1]]/255, freq_colors[[2]]/255, freq_colors[[3]]/255, 1, paste0("Freq: ", parcel_count_df$freq))[[1]]
img1
```

```{r}
# LH
img2 <- plot_plotly_atlas_whole_RH_LH(atlas, atlas_LH, atlas_RH, atlas_deep_LH, atlas_deep_RH, freq_colors[[1]]/255, freq_colors[[2]]/255, freq_colors[[3]]/255, 1, paste0("Freq: ", parcel_count_df$freq))[[2]]
img2
```

```{r}
# RH
img3 <- plot_plotly_atlas_whole_RH_LH(atlas, atlas_LH, atlas_RH, atlas_deep_RH, atlas_deep_LH, freq_colors[[1]]/255, freq_colors[[2]]/255, freq_colors[[3]]/255, 1, paste0("Freq: ", parcel_count_df$freq))[[3]]
img3
```
...
```{r}
# deep LH
img4 <- plot_plotly_atlas_whole_RH_LH(atlas, atlas_LH, atlas_RH, atlas_deep_RH, atlas_deep_LH, freq_colors[[1]]/255, freq_colors[[2]]/255, freq_colors[[3]]/255, 1, paste0("Freq: ", parcel_count_df$freq))[[4]]
img4
```
...
```{r}
# deep RH
img5 <- plot_plotly_atlas_whole_RH_LH(atlas, atlas_LH, atlas_RH, atlas_deep_RH, atlas_deep_LH, freq_colors[[1]]/255, freq_colors[[2]]/255, freq_colors[[3]]/255, 1, paste0("Freq: ", parcel_count_df$freq))[[5]]
img5
```
