---
title: "Visualization Tutorial for Yale Brain Atlas (690 parcel version)"
...
# Visualization Tutorial for Yale Brain Atlas (690 parcel version)
...
atlas_whole_positions <- read.csv("files/atlas_690/atlas_whole_positions.csv")
atlas_whole_indices <- read.csv("files/atlas_690/atlas_whole_indices.csv")
# Yale Brain Atlas left hemisphere positions and indices
atlas_LH_positions <- read.csv("files/atlas_690/atlas_LH_positions.csv")
atlas_LH_indices <- read.csv("files/atlas_690/atlas_LH_indices.csv")
# Yale Brain Atlas right hemisphere positions and indices
atlas_RH_positions <- read.csv("files/atlas_690/atlas_RH_positions.csv")
atlas_RH_indices <- read.csv("files/atlas_690/atlas_RH_indices.csv")
# Yale Brain Atlas deep left hemisphere (amygdala, hippocampus, insula) positions and indices
atlas_deepLH_positions <- read.csv("files/atlas_690/atlas_deepLH_positions.csv")
atlas_deepLH_indices <- read.csv("files/atlas_690/atlas_deepLH_indices.csv")
# Yale Brain Atlas deep right hemisphere (amygdala, hippocampus, insula) positions and indices
atlas_deepRH_positions <- read.csv("files/atlas_690/atlas_deepRH_positions.csv")
atlas_deepRH_indices <- read.csv("files/atlas_690/atlas_deepRH_indices.csv")
# Yale Brain Atlas parcel dictionary
parcel_dict <- read.csv("files/atlas_690/parcel_dict.csv")

# Coloring: Example data from Scientific Reports publication
parcel_electrode_count <- read.csv("files/atlas_690/parcel_electrode_count_atlas690.csv")
```
...
# Input 6: extra_text_values = 690-length vector of any additional information to be displayed in hovertext for 690 parcels
